...
- **Feature overview**: Interactive preview of the main app (mock header, filter tabs, sample cards). Users can tap filter tabs (**Public** with **Current** / **Answered** / **Total** sub-chips, **Prompts**, **Personal**) and open modals (Help, Settings, badges, prompt categories, personal actions) to see how the app works
