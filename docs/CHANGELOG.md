...
- Info page split: external [`info.component.html`](src/app/pages/info/info.component.html) / [`info.component.css`](src/app/pages/info/info.component.css); home filter mock preview in [`info-home-filter-preview`](src/app/components/info-home-filter-preview/info-home-filter-preview.component.ts).
