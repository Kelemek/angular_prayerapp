...
- **Email Subscribers** ([`email-subscribers.component.ts`](src/app/components/email-subscribers/email-subscribers.component.ts)): inline template extracted to [`email-subscribers.component.html`](src/app/components/email-subscribers/email-subscribers.component.html). CSV upload, add-subscriber (manual + Planning Center), edit modal, and list row UI split into [`admin-email-subscribers-csv-panel`](src/app/components/admin-email-subscribers-csv-panel/admin-email-subscribers-csv-panel.component.ts), [`admin-email-subscribers-add-form`](src/app/components/admin-email-subscribers-add-form/admin-email-subscribers-add-form.component.ts), [`admin-email-subscriber-edit-modal`](src/app/components/admin-email-subscriber-edit-modal/admin-email-subscriber-edit-modal.component.ts), and [`admin-email-subscriber-row`](src/app/components/admin-email-subscriber-row/admin-email-subscriber-row.component.ts) with shared types in [`admin-email-subscribers.ts`](src/app/lib/admin-email-subscribers.ts). Shell keeps list search, pagination, toggles, confirmations, and tour hooks (`addFormRef` / `csvPanelRef`).
