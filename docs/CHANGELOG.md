...
- Reverted the experimental **unified** virtual scroll for Public, Personal, and Members; Home again matches shipped behavior: **Prompts-only** CDK autosize virtual scroll ([`home-prompt-virtual-scroll.ts`](src/app/lib/home-prompt-virtual-scroll.ts), [`home-prayer-content`](src/app/components/home-prayer-content/home-prayer-content.component.html)); Public/Personal/Members use normal `@for` lists (stable scroll, no `checkViewportSize` resync loop).
