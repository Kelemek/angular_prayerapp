  ...
  startPrayerEncouragementTour(
    ...
    steps.push({
      popover: {
        ...
        description:
          'When Prayer Encouragement is enabled, <strong>Pray For</strong> lets you record that you prayed for a community, personal, or Planning Center member request (and on presentation slides). On community and member cards viewers only see a <strong>total count</strong>—your tap is anonymous. On personal cards you track your own <strong>{n} Prayers</strong> count. Members still appear only if you have a Planning Center list applied.<br><br>You can turn the button or the praying count off for yourself in <strong>Settings</strong> under prayer encouragement on cards. After you tap Pray For, a <strong>cooldown</strong> applies before you can tap again for the same request (personal / member cooldown in Settings; community uses the church-wide setting).',
        side: 'bottom',
        align: 'center',
        onNextClick: this.popoverNextKillsTour(),
      },
