    ...
    >
      <div class="max-w-md w-full mx-auto space-y-8 p-4 sm:p-8">
        ...
        <div class="space-y-4">
          ...
          <div
            class="bg-gradient-to-br from-emerald-50 to-green-50 dark:from-emerald-900/20 dark:to-green-900/20 border-2 border-emerald-300 dark:border-emerald-700 rounded-lg p-6 shadow-lg"
          >
            <div class="flex items-start gap-3 mb-4">
              <!-- CheckCircle Icon -->
              <svg
                class="text-[#2F5F54] dark:text-emerald-400 flex-shrink-0 mt-0.5 w-6 h-6"
                fill="none"
                stroke="currentColor"
                viewBox="0 0 24 24"
              >
            ...
            <div class="mt-4">
              <div
                class="bg-white dark:bg-gray-800 rounded-md p-4 border border-emerald-200 dark:border-emerald-800 space-y-4"
              >
                <h4
                ...
                >
                  ...
                  <span
                    class="text-sm font-semibold text-[#2F5F54] dark:text-emerald-300"
                    >Verifying code...</span
                  >
                </div>
                }
                ...
                <div
                  class="flex items-center gap-2 p-3 bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-800 rounded-md"
                >
                  <!-- AlertCircle Icon -->
                  <svg
          ...
          <div class="mt-4">
            ...
            >
              <div>
                ...
                >
                  <svg
                    class="text-amber-600 dark:text-amber-400 w-5 h-5 mt-0.5 flex-shrink-0"
                    fill="none"
                    stroke="currentColor"
                    viewBox="0 0 24 24"
                  >
                  ...
                  <div class="text-xs text-amber-800 dark:text-amber-200">
                    ...
                    <p>
                      Your email was not found in our system. After submitting
                      your information, an administrator will need to approve
                      your account before you can access the application.
                    </p>
                  </div>
                </div>
                }
          ...
          <div class="mt-4">
            ...
            >
              <div class="flex items-start gap-3">
                <svg
                  class="text-emerald-600 dark:text-emerald-400 w-6 h-6 flex-shrink-0"
                  fill="none"
                  stroke="currentColor"
                  viewBox="0 0 24 24"
                >
                ...
                <div>
                  ...
                  <p class="text-sm text-gray-600 dark:text-gray-400 mb-3">
                    Your account request has been submitted successfully. An
                    administrator will review your information and you'll
                    receive an email notification once your account has been
                    approved or if additional information is needed.
                  </p>
                  <p class="text-sm text-gray-600 dark:text-gray-400">
                    You can close this window now. Please check your email for
          ...
          <div class="mt-4">
            <div
              class="bg-white dark:bg-gray-800 rounded-md p-4 border border-amber-200 dark:border-amber-800 space-y-4"
            >
              <div class="flex items-start gap-3">
                <svg
                  class="text-amber-600 dark:text-amber-400 w-6 h-6 flex-shrink-0"
                  viewBox="0 0 24 24"
                  fill="none"
                  stroke="currentColor"
                  stroke-width="2"
                ...
                <div>
                  ...
                  <p class="text-sm text-gray-600 dark:text-gray-400 mb-3">
                    Your account has been temporarily restricted and you are
                    unable to access the prayer community at this time.
                  </p>
                  <p class="text-sm text-gray-600 dark:text-gray-400">
                    Please contact an administrator for assistance in restoring
                    your account access.
                  </p>
                </div>
              </div>
          ...
          <div
            class="mt-4 bg-white dark:bg-gray-800 rounded-md p-4 border border-emerald-200 dark:border-emerald-800"
          >
            <h4
              class="text-sm font-semibold text-gray-900 dark:text-gray-100 mb-3"
            >
            ...
            <ol class="space-y-2 text-sm text-gray-700 dark:text-gray-300">
              <li class="flex items-start gap-2">
                <span
                  class="flex-shrink-0 w-5 h-5 bg-[#2F5F54] dark:bg-emerald-500 text-white rounded-full flex items-center justify-center text-xs font-bold"
                  >1</span
                >
                <span
                  >Check your email inbox for a message from Prayer
                  Community</span
                >
              </li>
              <li class="flex items-start gap-2">
                ...
                <span
                  >Look for the
                  <strong>{{ codeLength }}-digit verification code</strong> in
                  the email</span
                >
              </li>
              <li class="flex items-start gap-2">
                ...
                >
                <span
                  >Enter the code above and it will verify automatically</span
                >
              </li>
            </ol>
          </div>
          ...
          @if (waitingForMfaCode) {
          <div
            class="mt-4 flex items-start gap-2 text-xs text-[#3a7566] dark:text-emerald-300"
          >
            <!-- Info Icon -->
            <svg
            ...
            <p>
              <strong>No email?</strong> Check your spam folder. The code
        ...
        <form class="mt-8 space-y-6" (ngSubmit)="handleSubmit($event)">
          <div>
            ...
            <div class="relative">
              <!-- Mail Icon -->
              <svg
                class="absolute left-3 top-1/2 transform -translate-y-1/2 text-[#2F5F54] w-5 h-5"
                fill="none"
                stroke="currentColor"
                viewBox="0 0 24 24"
              >
...
export class LoginComponent implements OnInit, OnDestroy {
  ...
  private async checkEmailSubscriberAndNavigate(
    userEmail: string,
    isAdmin: boolean
  ) {
    try {
      ...
      const errorMsg =
        blockError instanceof Error ? blockError.message : "Access denied";
