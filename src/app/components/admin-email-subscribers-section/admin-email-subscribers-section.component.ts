...
@Component({
  selector: 'app-admin-email-subscribers-section',
  standalone: true,
  imports: [CommonModule],
  changeDetection: ChangeDetectionStrategy.OnPush,
  templateUrl: './admin-email-subscribers-section.component.html',
})
export class AdminEmailSubscribersSectionComponent {
